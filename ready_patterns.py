...
def call_found(obj, ctx):
    ...
    print 'ida_xref.add_cref(%#x, %#x, %d)' % (call.ea, to_addr, ida_xref.fl_CN | ida_xref.XREF_USER)
    print ida_xref.add_cref(call.ea, to_addr, ida_xref.fl_CN | ida_xref.XREF_USER)

debug_pattern = 'Patterns.NoPattern()'

PATTERNS = [(call_pattern, call_found, False)]